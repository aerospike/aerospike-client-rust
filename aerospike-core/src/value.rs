...
impl Value {
    ...
    pub fn estimate_size(&self) -> usize {
        match *self {
            ...
            Value::Bool(_) => 1,
            Value::List(_) | Value::HashMap(_) | Value::OrderedMap(_) => encoder::pack_value(&mut None, self),
    ...
    pub fn write_to(&self, buf: &mut Buffer) -> usize {
        match *self {
            ...
            Value::List(_) | Value::HashMap(_) | Value::OrderedMap(_) => encoder::pack_value(&mut Some(buf), self),
