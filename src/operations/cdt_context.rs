...
pub fn ctx_list_index<'a>(index: i64) -> CdtContext<'a> {
    CdtContext {
        id: 0x10,
...
/// -1 = largest value
pub fn ctx_list_rank<'a>(rank: i64) -> CdtContext<'a> {
    CdtContext {
        id: 0x11,
...
/// N = Nth smallest value
/// -1 = largest value
pub fn ctx_map_rank<'a>(rank: i64) -> CdtContext<'a> {
    CdtContext {
        id: 0x21,
        value: &Value::Int(rank),
    }
