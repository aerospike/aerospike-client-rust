...
pub mod common1 {
    ...
    lazy_static! {
	    ...
	    pub static ref GLOBAL_CLIENT_POLICY: ClientPolicy = ClientPolicy::default();
	    pub static ref GLOBAL_CLIENT: Arc<Client> = Arc::new(Client::new(&GLOBAL_CLIENT_POLICY, &vec![Host::new(&AEROSPIKE_HOST, *AEROSPIKE_PORT)]).unwrap());
	}
}
